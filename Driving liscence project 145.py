# -*- coding: utf-8 -*-
"""
Created on Thu Dec  3 16:32:55 2020
...
def myDrivingLicense() :
 ...
 pin = 567890
 print(type(pin))
 address = "Tulsi Vihar, Sec-19, Kharghar, Navi Mumbai"
 print(type(address))
 listOfVehicles = ["Two", "Four"]
 print(type(listOfVehicles))
 ...
 label_vehicle_type["text"] = listOfVehicles
 
    
    
# Create a button
button1 = Button(root, text = "Show My Driving Licsense", command=myDrivingLicense)
